...
def main():
    ...
    # get outputs
    print("Outputs:")
    print(src_1.get_output().get_name())    # Tap_1
    print(tap_1.get_output().get_name())    # Split_1
    print([e.get_name() for e in spl_1.get_outputs()])                 # ['Sink_1', 'Sink_2']

    # test override connect for sink
    snk_1.connect(snk_2)
    print(snk_1.get_output().get_name() if snk_1.get_output() is not None else None)  # Split_1
